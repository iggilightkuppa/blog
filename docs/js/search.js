    ...
    $.getJSON('https://iggilightkuppa.github.io/blog/search.json', function(posts) {
        ...
        if(matchedPosts.length) {
            ...
            matchedPosts.forEach(function(postInfo) {
                ...
                dl.append('<dt><a class="post-link" href="' + postInfo.url + '">' + postInfo.title + '</a></dt>');
                if(postInfo.date) {
                ...
                if(postInfo.tags.length) {
                    ...
                    postInfo.tags.forEach(function(tag, tagIndex, tags) {
                        tagList += '<a href="https://iggilightkuppa.github.io/blog/search.html?q=%5B' + tag['tagName'] + '%5D">' + tag['tagName'] + '<span>[' + tag['count'] + ']</span></a>';
